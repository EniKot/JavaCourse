...
public class StudentController extends ToolController {
    ...
    @FXML
    private TableColumn<Map,String> teachNoColumn; //学生信息表 课序号列
    @FXML
    private TableColumn<Map,String> teamNoColumn; //学生信息表 团队编号列
    @FXML
    private TableColumn<Map,String> laboratoryColumn; //学生信息表 实验室列
    @FXML
    private TableColumn<Map,Double> teamScoreColumn; //学生信息表 团队成绩列
    @FXML
    private TableColumn<Map,Double> weightColumn; //学生信息表 权重列
    @FXML
    private TableColumn<Map,Double> scoreColumn; //学生信息表 个人成绩列
    @FXML
    private TableColumn<Map,String> levelColumn; //学生信息表 上报成绩列
    @FXML
    ...
    public void initialize() {
        ...
        teamNoColumn.setCellValueFactory(new MapValueFactory<>("teamNoName"));
        laboratoryColumn.setCellValueFactory(new MapValueFactory<>("laboratoryName"));
        teamScoreColumn.setCellValueFactory(new MapValueFactory<>("termScore"));
